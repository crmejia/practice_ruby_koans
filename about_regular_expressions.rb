...
class AboutRegularExpressions < Neo::Koan
  ...
  def test_asterisk_means_zero_or_more
    ...
    #never? it always matchese because is 0 or more
  end
  ...
  #
  # Why?
  #because they take more than one element. THey take all occurrences, 1 or more 0 or more
...
#they are very different contents. alternation behaves more like a operator that a class, so I guess it can take multiple characters classes at the same time
