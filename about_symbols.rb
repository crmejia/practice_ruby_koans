...
class AboutSymbols < Neo::Koan
  ...
  #Because symbols are unique and otherwhise we would be comparing object identity and no the content
  ...
  #because they are unique an take time to create(not very efficient)?
end
